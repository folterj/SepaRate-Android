...
public class GameModel {
	...
	ArrayList<ControlObserver> controlObservers = new ArrayList<>();
	...
	Cont feed;
	ArrayList<Cont> cont;
	Vector<LevelPurity> levelPurities = new Vector<>();
	int maxCont;
	Cont curcont;
	int totcomps;
